  ...
  const [prestacion, setPrestacion] = useState<Prestacion | null>(
    cirugia.codigo_practica
      ? {
          ...
          detalle: cirugia.nombre_practica,
          honorarios: cirugia.honorarios,
          gastos: cirugia.gastos,
          total: cirugia.total,
          seccion: '',
          categoria: null,
    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              type="text"
              required
              defaultValue={cirugia.nombre_paciente}
        ...
        <div>
          ...
          <PracticaAutocomplete
            ...
            value={cirugia.codigo_practica ? `${cirugia.codigo_practica} - ${cirugia.nombre_practica}` : undefined}
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input
              name="anestesiologo"
              type="text"
              defaultValue={cirugia.anestesiologo ?? ''}
              placeholder="Dr. ..."
              className="w-full px-4 py-3 rounded-lg text-sm"
              style={{
                background: 'var(--color-background)',
          ...
          <div>
            ...
            <input
              name="instrumentador"
              type="text"
              defaultValue={cirugia.instrumentador ?? ''}
              placeholder="Nombre..."
              className="w-full px-4 py-3 rounded-lg text-sm"
              style={{
                background: 'var(--color-background)',
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              name="tipo_anestesia"
              defaultValue={cirugia.tipo_anestesia ?? ''}
              className="w-full px-4 py-3 rounded-lg text-sm"
              style={{
                background: 'var(--color-background)',
                border: '1px solid var(--color-border)',
          ...
          <div>
            ...
            <input
              ...
              type="number"
              min="0"
              defaultValue={cirugia.duracion_minutos ?? ''}
              placeholder="60"
              className="w-full px-4 py-3 rounded-lg text-sm"
              style={{
                background: 'var(--color-background)',
      ...
      <div>
        ...
        <textarea
          name="observaciones"
          rows={3}
          defaultValue={cirugia.observaciones ?? ''}
