import type { EstadoCirugia } from '../types/cirugias'

const STATUS_CONFIG: Record<EstadoCirugia, { label: string; className: string }> = {
  borrador: {
    label: 'Borrador',
...
export function CirugiaStatusBadge({ estado }: Props) {
